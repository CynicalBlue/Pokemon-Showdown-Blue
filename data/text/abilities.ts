export const AbilitiesText: {[k: string]: AbilityText} = {
	...
	ancienttrickery: {
		name: "Ancient Trickery",
		shortDesc: "On switch-in, this Pokemon summons Trick Room.  Cannot be extended with Room Upkeep.",
	},
	angerpoint: {
		name: "Anger Point",
	...
	arcane: {
		name: "Arcane",
		shortDesc: "On switch-in, this Pokemon summons Magic Room.  Cannot be extended with Room Upkeep.",
	},
	arenatrap: {
		name: "Arena Trap",
	...
	heavymetal: {
		name: "Heavy Metal",
		desc: "This Pokemon's weight is quadrupled. This effect is calculated after the effect of Autotomize, and before the effect of Float Stone.",
	...
	hydraulic: {
		name: "Hydraulic",
		shortDesc: "This Pokemon's Water-type moves have their priority increased by 1.",
	},
	hypercutter: {
		name: "Hyper Cutter",
	...
	lightmetal: {
		name: "Light Metal",
		desc: "This Pokemon's weight is reduced to a fourth, rounded down to a tenth of a kilogram. This effect is calculated after the effect of Autotomize, and before the effect of Float Stone. A Pokemon's weight will not drop below 0.1 kg.",
		shortDesc: "This Pokemon's weight is reduced to a fourth.",
	},
	lightningrod: {
		name: "Lightning Rod",
	...
	marvelous: {
		name: "Marvelous",
		shortDesc: "On switch-in, this Pokemon summons Wonder Room.  Cannot be extended with Room Upkeep.",
	},
	marvelscale: {
		name: "Marvel Scale",
	...
	megalauncher: {
		name: "Mega Launcher",
		desc: "This Pokemon's pulse, aura, and beam moves have their power multiplied by 2. Heal Pulse restores 3/4 of a target's maximum HP, rounded half down.",
		shortDesc: "This Pokemon's pulse, aura, and beam moves have 2x power. Heal Pulse heals 3/4 target's max HP.",
	},
	merciless: {
		name: "Merciless",
	...
	natureadept: {
		name: "Nature Adept",
		desc: "This Pokemon is immune to Bug-type, Flying-type, and Poison-type moves.",
		shortDesc: "Bug/Flying/Poison immunity.",
	},
	neuroforce: {
		name: "Neuroforce",
	...
	overcoat: {
		name: "Overcoat",
		desc: "This Pokemon is immune to powder moves, damage from Sandstorm, the effects of Rage Powder and the Effect Spore Ability, and Ice moves.",
		shortDesc: "This Pokemon is immune to powder moves, Sandstorm damage, Effect Spore, and Ice moves.",
		gen8: {
	...
	reinforced: {
		name: "Reinforced",
		shortDesc: "This Pokemon is immune to aura, pulse, and beam moves.",
	},
	ripen: {
		name: "Ripen",
	...
	scrappy: {
		name: "Scrappy",
		desc: "This Pokemon can hit types with their type immunities. This Pokemon is immune to the effect of the Intimidate Ability.",
		shortDesc: "Ignores type immunities. Immune to Intimidate.",
		gen7: {
	...
	stall: {
		name: "Stall",
		desc: "If this Pokemon is the target of an opposing Pokemon's move, that move loses two additional PP. Imprison, Snatch, and Tera Blast also lose two additional PP when used by an opposing Pokemon, but Sticky Web does not.",
