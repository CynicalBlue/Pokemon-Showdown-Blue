export const MovesText: {[k: string]: MoveText} = {
	...
	bind: {
		name: "Bind",
		desc: "Prevents the target from switching for four or five turns (seven turns if the user is holding Grip Claw). Causes damage to the target equal to 1/6 of its maximum HP (1/4 if the user is holding Binding Band), rounded down, at the end of each turn during effect. The target can still switch out if it is holding Shed Shell or uses Baton Pass, Flip Turn, Parting Shot, Shed Tail, Teleport, U-turn, or Volt Switch. The effect ends if either the user or the target leaves the field, or if the target uses Mortal Spin, Rapid Spin, or Substitute successfully. This effect is not stackable or reset by using this or another binding move.",
	...
	chatter: {
		name: "Chatter",
		desc: "This move combines Sound in its type effectiveness against the target and has a 100% chance to confuse the target.",
		shortDesc: "Combines Sound in its type effectiveness and has a 100% chance to confuse the target.",
		gen5: {
	...
	drumbeating: {
		name: "Drum Beating",
		desc: "This move combines Sound in its type effectiveness against the target and has a 100% chance to lower the target's Speed by 1 stage.",
		shortDesc: "Combines Sound in its type effectiveness and has a 100% chance to lower the target's Speed by 1.",
	},
	dualchop: {
		name: "Dual Chop",
		desc: "Hits twice. If the first hit breaks the target's substitute, it will take damage for the second hit.",
	...
	feintattack: {
		name: "Feint Attack",
		shortDesc: "This move does not check accuracy and always results in a critical hit.",
	},
	fellstinger: {
		name: "Fell Stinger",
	...
	mistyterrain: {
		name: "Misty Terrain",
		desc: "For 5 turns, the terrain becomes Misty Terrain.  During the effect, the power of Fairy-type attacks used by grounded Pokemon is multiplied by 1.3, the power of Dragon-type attacks used against grounded Pokemon is multiplied by 0.5 and grounded Pokemon cannot be inflicted with a non-volatile status condition nor confusion. Grounded Pokemon can become affected by Yawn but cannot fall asleep from its effect. Camouflage transforms the user into a Fairy type, Nature Power becomes Moonblast, and Secret Power has a 30% chance to lower Special Attack by 1 stage. Fails if the current terrain is Misty Terrain.",
		shortDesc: "5 turns. Can't status, -Dragon power and +Fairy power vs grounded.",
		gen6: {
	...
	nobleroar: {
		...
		shortDesc: "Lowers the target's Attack and Sp. Atk by 2.",
	},
	noretreat: {
		name: "No Retreat",
	...
	overdrive: {
		name: "Overdrive",
		desc: "This move combines Sound in its type effectiveness against the target and has a 20% chance to inflict Par.  Hits foe(s).",
		shortDesc: "Combines Sound in its type effectiveness and has a 20% chance to inflict Par. Hits foe(s).",
	},
	overheat: {
		name: "Overheat",
		desc: "Lowers the user's Special Attack by 2 stages.",
	...
	razorwind: {
		name: "Razor Wind",
		desc: "Has a higher chance for a critical hit. This attack charges on the first turn and executes on the second. If the user is holding a Power Herb or if Tailwind is up on their side, the move completes in one turn.",
		shortDesc: "Charges (unless Tailwind), then hits foe(s) turn 2. High crit ratio.",
		gen4: {
	...
	slurp: {
		name: "Slurp",
		desc: "Paralyze target and disable them. If this move is successful, the user switches out even if it is trapped and is replaced immediately by a selected party member. The user does not switch out if the target's Attack and Special Attack stat stages were both unchanged, or if there are no unfainted party members.",
		shortDesc: "Par and disable target. User switches.",
	...
	soundtherapy: {
		name: "Sound Therapy",
		desc: "The user restores 1/2 of its maximum HP, rounded half up.  Fails if user is Space type or has the Soundproof ability.",
		shortDesc: "Heals the user by 50% of its max HP.  Fails if Space Type or if user has Soundproof.",
	},
	spacialrend: {
		name: "Spacial Rend",
		desc: "Has a higher chance for a critical hit.",
	...
	sparklingaria: {
		name: "Sparkling Aria",
		desc: "This move combines Sound in its type effectiveness against the target.  If the user has not fainted, the target is cured of its burn.",
		shortDesc: "Combines Sound in its type effectiveness.  The target is cured of its burn.",
	},
	sparklyswirl: {
		name: "Sparkly Swirl",
		desc: "Every Pokemon in the user's party is cured of its non-volatile status condition.",
	...
	strengthsap: {
		name: "Strength Sap",
		desc: "Lowers the target's Attack by 1 stage. The user restores its HP equal to the target's Attack stat calculated with its stat stage before this move was used. If Big Root is held by the user, the HP recovered is 2x normal, rounded half down. Fails if the target's Attack stat stage is -6.",
	...
	throatchop: {
		name: "Throat Chop",
		desc: "For 2 turns, the target cannot use sound-based moves.  This move's type effectiveness against Sound is changed to be super effective no matter what this move's type is.",
		shortDesc: "For 2 turns, the target cannot use sound moves.  Super effective on Sound",
		gen7: {
	...
	torchsong: {
		name: "Torch Song",
		desc: "This move combines Sound in its type effectiveness against the target and has a 100% chance to raise the user's Special Attack by 1 stage.",
		shortDesc: "Combines Sound in its type effectiveness and has a 100% chance to raise the user's Sp. Atk by 1.",
	},
	torment: {
		name: "Torment",
	...
	willdrain: {
		name: "Will Drain",
		desc: "Lowers the target's Special Attack by 1 stage. The user restores its HP equal to the target's Special Attack stat calculated with its stat stage before this move was used. If Big Root is held by the user, the HP recovered is 2x normal, rounded half down. Fails if the target's Special Attack stat stage is -6.",
	...
	wonderroom: {
		name: "Wonder Room",
		desc: "For 5 turns, stat increases that occur become decreases and vice versa.  If this move is used during the effect, the effect ends.",
		shortDesc: "For 5 turns, stat changes are reversed when gained.",
	},
	woodhammer: {
		name: "Wood Hammer",
		desc: "If the target lost HP, the user takes recoil damage equal to 33% the HP lost by the target, rounded half up, but not less than 1 HP.",
