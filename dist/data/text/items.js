...
const ItemsText = {
  ...
  bigroot: {
    name: "Big Root",
    desc: "Holder gains 2x HP from draining/Aqua Ring/Ingrain/Leech Seed/Strength Sap.",
    gen6: {
      desc: "Holder gains 2x HP from draining moves, Aqua Ring, Ingrain, and Leech Seed."
    }
  },
  bindingband: {
    name: "Binding Band",
  ...
  roomamenities: {
    name: "Room Amenities",
    desc: "If Trick Room is active, the holder's speed is halved."
  },
  roomcheckout: {
    name: "Room Checkout",
    desc: "If a Room is active, the holder switches out. Single use."
  },
  roomkey: {
    name: "Room Key",
    desc: "This Pokemon ignores the effects of Magic Room."
  },
  roomservice: {
    name: "Room Service",
    desc: "If Wonder Room is active, the holder's Atk, Spa, Def, Spd, and Spe is lowered by 1 stage. Single use."
  },
  roomupkeep: {
    name: "Room Upkeep",
    desc: "Holder's use of Trick/Magic/Wonder Room lasts 8 turns instead of 5 unless they have an ability that would summon a room on switch-in."
  },
  rootfossil: {
    name: "Root Fossil",
  ...
  zoomlens: {
    name: "Zoom Lens",
    desc: "The accuracy of attacks by the holder is 1.3x if it moves after its target."
  },
  // Gen 2 items
  berserkgene: {
    name: "Berserk Gene",
