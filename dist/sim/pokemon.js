  ...
  */
  ...
  ignoringAbility() {
    ...
    if (this.volatiles["gastroacid"])
      return true;
    if (this.battle.field.pseudoWeather["magicroom"] && !this.hasItem("roomkey"))
      return true;
  ...
  ignoringItem() {
    return !!(this.itemState.knockedOff || this.battle.gen >= 5 && !this.isActive || !this.getItem().ignoreKlutz && this.hasAbility("klutz") || this.volatiles["embargo"]);
  }
